<?php
/**
 * gallery.php = this file generates the content for the gallery page.
 */
?>
        ...
        <div class="col">
            <section class="spin_gallery" id="spin_gallery">
                <div class="spin">
                    <div class="spin_wrap">
                     ...
                     <!--   <div class="spin_img toggle_front_image">0<img src="img/new/brust.jpg"  alt="Brustplatte auf Fell"></div>
                        ...
                        <div class="spin_img">4<img src="img/new/armschiene.jpg"  alt="Armschiene auf Fell"></div>
                        <div class="spin_img">5<img src="img/new/ruecken.jpg"  alt="Rueckenplatte auf Fell"></div>
                ...
                <div class="spin-options" id="spin-options">
                    <p>
                        <button class="previous-button btn_1 btn" aria-label="zeigt das letzte Bild"><i class="fa  fa-angle-left"></i>&#x2190; </button>
                        <button class="next-button btn_1 btn" aria-label="zeigt das nächste Bild"><i class="fa fa-angle-right">	&#x2192;</i> </button>
                    </p>
                </div>
            </section>
        </div>
