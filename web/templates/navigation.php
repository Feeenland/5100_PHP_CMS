    ...
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-md-10">
                            ...
                            <li class="nav-item">
                                <?php if (isset($_SESSION['logged_in'])) { ?>
                                    ...
                                    <?php }else{ ?>
                                        ...
                                        <button class="btn btn_1"><a class="nav-link <?php ?>" href="index.php?p=admin">Seite Bearbeiten</a></button>
                                    <?php } ?>
                                <?php } else{?>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark justify-content-between nav_styles font_wind ">
                <a class="navbar-brand" href="#"><!--<img src="img/logo_patterns/cat_logo.png" alt="">--> LOGO</a>
